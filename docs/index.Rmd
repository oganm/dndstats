...
*Edited: 18 August 2018 (see [changlelog](#changelog))*
...
It can be postulated players spend most of their time between levels 4-15. `r uniqueTable %>% filter(as.integer(levelGroup) %in% c(2,3,4)) %>% {round(sum(.$feats!='')/nrow(.)*100)}`% of all characters
